...
<head>
    ...
    <title>Commits - {{ config('app.name', 'Laravel') }}</title>
                                ...
                                <div class="flex items-start justify-between">
                                    <div class="flex-1">
                                        ...
                                        <div class="flex items-center gap-4 mb-3">
                                            ...
                                            >
                                                ...
                                                @if ($commit['repository']['language'])
                                                    <span
                                                        class="ml-2 text-xs text-gray-500">{{ $commit['repository']['language'] }}</span>
                                                @endif
                                            </a>
                                        </div>
                                        ...
                                        <div class="flex items-center text-sm text-gray-600 mb-3">
                                            ...
                                            >
                                            <span class="mr-4">{{ $commit['author']['name'] }}</span>
                                            <span>{{ $commit['date_human'] }}</span>
                                        </div>
                                        ...
                                        <div class="flex items-center gap-3">
                                            ...
                                            <span
                                                class="text-xs text-gray-400 font-mono">{{ $commit['short_id'] }}</span>
                                            @if ($commit['verified'])
                                                <span
